...
### Como é feita a monetização da plataforma

Para candidatos o cadastro e candidatura às vagas é completamente gratuito, já que podemos ter bons profissionais em difícil situação financeira.

Para as empresas há a cobrança de valor único pelo anúncio da vaga (para cada vaga anunciada há uma cobrança).

A análise dos mini-currículos é gratuita, porém será cobrada uma pequena taxa para acesso ao perfil completo de cada candidato selecionado.
